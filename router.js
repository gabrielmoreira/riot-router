(function(riot) {
  ...
  riot.router.Route = Route;
  riot.router.DefaultRoute = DefaultRoute;
  riot.router.RedirectRoute = RedirectRoute;
  riot.router.NotFoundRoute = NotFoundRoute;
  riot.router._ = {Response: Response, Request: Request};
})(riot || window.riot || global.riot);